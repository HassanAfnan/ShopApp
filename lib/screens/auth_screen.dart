...
class _AuthCardState extends State<AuthCard>  with SingleTickerProviderStateMixin {
  ...
  void _showErrorDialog(String message){
     showDialog(context: context,builder: (cyx) => AlertDialog(
       title: Text('Error'),
  ...
  void _submit() async {
    ...
    try {
      ...
      if(error.toString().contains('EMAIL_EXISTS')){
        errorMessage = 'This email is already exsists';
      }
      else if(error.toString().contains('INVALID_EMAIL')){
        errorMessage = 'This is not a vakid email';
      }
      ...
      const errorMessage = 'Could not login.Please try again';
      _showErrorDialog(errorMessage);
    }
    setState(() {
      _isLoading = false;
